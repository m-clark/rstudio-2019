...
Many packages use various Javascript libraries to provide interactivity
...
df %>%
  plot_ly(
    ...
    text = ~hover, 
    color = ~cnt, 
    marker = list(size = ~scales::rescale(df$pop, c(3, 20))), 
    type = 'scattergeo', 
  ...
  layout(
    title = 'Most trafficked US airports<br>(Hover for airport info)', 
    geo = g,
...
Most of the more recently developed visualization packages will work specifically within the Shiny and R Markdown settings

Other tools make working with Shiny easier (e.g. <span class="pack">flexdashboard</span>)
